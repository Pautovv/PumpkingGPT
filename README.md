# **MicroGPT-from-Scratch: Реализация decoder-only архитектуры с поддержкой автоматического дифференцирования на чисто Python**
...
## **3. Казуальное многоголовое внимание**
...
### **4.2. Векторное представление токенов**
...
## **Результаты обучения и Визуализация**
